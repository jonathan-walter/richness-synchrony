# =============================================================================================
# SPATIAL SYNCHRONY FORMATTING AND ANALYSIS FOR JORNADA (KNZ - Lowland [t]) DATA
# =============================================================================================
# ---------------------------------------------------------------------------------------------
# Revised by Max Castorani, University of Virginia, castorani@virginia.edu
# and Jonathan Walter, University of Virginia, jaw3es@virginia.edu
# Revised on 2018-05-09, 2018-08-03
# ---------------------------------------------------------------------------------------------
rm(list=ls())
# ---------------------------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------------------------
# Select data
dat<-grasslands[grasslands$site=="knz",]
dat<-dat[dat$habitat=="t",]

# ---------------------------------------------------------------------------------------------
# Clone specific data sets with a generic name
dat.name <- 'knz_t_lowland'
dat.site <- 'knz'
dat.habitat <- 't'
dat.project <- NA
...
knz_t_lowland_results <- CommSpatSynch(inarray = data_array, do.Modularity=F, do.Mantel=F)
