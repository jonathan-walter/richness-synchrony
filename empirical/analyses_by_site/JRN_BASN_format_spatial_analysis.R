# =============================================================================================
# SPATIAL SYNCHRONY FORMATTING AND ANALYSIS FOR JORNADA (JRN - BASN) DATA
# =============================================================================================
# ---------------------------------------------------------------------------------------------
...
pdf(file=here("figures/supplement/jrn_basn_sp_acc_space.pdf"), width = 7, height = 4.7)
