...
dat<-dat[dat$plot %in% c("Alligator_Deep","Alligator_Shallow","Dustan_Rocks","Sombrero_Deep",
                         "Sombrero_Shallow","Tennessee_Deep","Tennessee_Shallow","West_Turtle_Shoal"),]
# ---------------------------------------------------------------------------------------------
...
saveRDS(mdk_coral_results, file = here("empirical/analyses_by_site/output",paste(dat.name, "_results.rds", sep ="")))
