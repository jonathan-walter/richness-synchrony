# =============================================================================================
# SPATIAL SYNCHRONY FORMATTING AND ANALYSIS FOR LOWER KEYS CORALS DATA
# =============================================================================================
# ---------------------------------------------------------------------------------------------
...
dat<-dat[dat$plot %in% c("Cliff_Green","Eastern_Sambo_Deep","Eastern_Sambo_Shallow","Jaap_Reef","Looe_Key_Deep",
                         "Looe_Key_Shallow","Rock_Key_Deep","Rock_Key_Shallow","Sand_Key_Deep","Sand_Key_Shallow",
                         "West_Washer_Women","Western_Head","Western_Sambo_Deep","Western_Sambo_Shallow"),]
...
lok_coral_results <- CommSpatSynch(inarray = data_array, do.Modularity = F, do.Mantel=F)
